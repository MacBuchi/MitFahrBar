...
- **Android:** Bundle-ID `de.mcbuchi.mitfahrbar` — zweimal umgezogen: mit
  ...
  v0.83.0 von `de.macbuchi.mitfahrbar` auf die **echte Domain** `mcbuchi.de`.
  ...
  - **Die alte Firebase-Android-App bleibt stehen.** Im Projekt `mitfahrbar`
    liegen seit v0.83.0 zwei: `de.macbuchi.mitfahrbar` (alt) und
  ...
  - **Der Kotlin-Pfad folgt der ID**, und der Test leitet ihn seit v0.83.0
